    ...
    >
      ...
      <div class="mt-auto flex flex-col lg:flex-row-reverse items-start lg:items-center lg:justify-end">
        <NuxtImg
            ...
            class="hidden  lg:block lg:absolute lg:top-0 lg:right-full lg:mr-8 lg:h-48 md:h-36 object-cover object-center rounded-2xl shadow-lg group-hover:scale-[1.02] transition-all duration-500 cursor-pointer"
            width="300"
            :src="image"
...
const formatDate = (date) => {
  ...
  return new Date(date).toLocaleDateString("zn", options);
};
</script>
